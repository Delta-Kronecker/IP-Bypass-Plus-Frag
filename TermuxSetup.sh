...
chmod +x ip-bypass-plus-frag/termux/ip-bypass-plus-frag
...
if ! grep -q "alias i='~/ip-bypass-plus-frag/termux/ip-bypass-plus-frag'" "$SHELL_RC" 2>/dev/null; then
    echo "alias i='~/ip-bypass-plus-frag/termux/ip-bypass-plus-frag'" >> "$SHELL_RC"
